...
6. Add more cloud resume examples now that explicit `resume` is available and additional providers can consume shared checkpoint URIs.
7. Add explicit container download helpers after the managed object-store staging path proves stable.
